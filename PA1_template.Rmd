...
ggplot(data=projsumday, aes(obsdate, totsteps)) +
  geom_histogram(stat="identity",position="dodge" ,color='red', fill ='red') + 
...
ggplot(data=projsumdaym, aes(obsdate, totsteps)) +
  geom_histogram(stat="identity",position="dodge" ,color='red', fill ='red') + 
  xlab("Step per Day") +
  ylab("Date of Observaton")
```
